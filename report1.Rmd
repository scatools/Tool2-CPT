...
This report evaluates `r length(params$footprint$proposal)` areas of interest.

##### The areas of interest were evaluated based on how well they achieved each goal of the RESTORE Council, with scores for each plan displayed in the following table. The user-provided weights, which indicate the relative importance of each goal in the analysis, are shown in the right column.   
